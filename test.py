...
def brash(proxy_dict):
    ...
    try:
        ...
        req = urllib.request.Request(url="https://www.maimemo.com/share/page?uid=4401757&pid=2f83c11fcad57e83972ebd37fd5ca12f&tid=dd0b808e149862754c0745bfdb58b5fe", headers=header)
